...
## makeCacheMatrix() generate a list. x is supposed to be a invertible matrix.
### mset() is used to update new squred matrix.
### to run this function, attribute makeCacheMatrix(x) to an object.
